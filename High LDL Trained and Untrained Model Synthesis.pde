...
oxLDL consumption, monocyte migration, total macrophages, and total foam cells in a HIGH LDL system}

{FlexPDE7 documentation is available at: https://www.pdesolutions.com/help/}

TITLE 'High LDL Trained and Untrained Model Synthesis'
COORDINATES
	Cartesian1
VARIABLES
...
DEFINITIONS
    ...
    l1 = table("Untrained Source Model_output/l(0)_UHSigmam_1")
    l2 = table("Untrained Source Model_output/l(0)_UHSigmam_2")
    l3 = table("Untrained Source Model_output/l(0)_UHSigmam_3")
    l4 = table("Untrained Source Model_output/l(0)_UHSigmam_4")
    a1 = table("Untrained Source Model_output/a(0)_UHSigmam_1")
    a2 = table("Untrained Source Model_output/a(0)_UHSigmam_2")
    a3 = table("Untrained Source Model_output/a(0)_UHSigmam_3")
    a4 = table("Untrained Source Model_output/a(0)_UHSigmam_4")
    c1 = table("Untrained Source Model_output/c(0)_UHSigmam_1")
    c2 = table("Untrained Source Model_output/c(0)_UHSigmam_2")
    c3 = table("Untrained Source Model_output/c(0)_UHSigmam_3")
    c4 = table("Untrained Source Model_output/c(0)_UHSigmam_4")
    m1 = table("Untrained Source Model_output/int(m)_UHSigmam_1")
    m2 = table("Untrained Source Model_output/int(m)_UHSigmam_2")
    m3 = table("Untrained Source Model_output/int(m)_UHSigmam_3")
    m4 = table("Untrained Source Model_output/int(m)_UHSigmam_4")
    f1 = table("Untrained Source Model_output/int(f)_UHSigmam_1")
	f2 = table("Untrained Source Model_output/int(f)_UHSigmam_2")
    f3 = table("Untrained Source Model_output/int(f)_UHSigmam_3")
    f4 = table("Untrained Source Model_output/int(f)_UHSigmam_4")
    ...
    Tl1 = table("Trained Source Model_output/l(0)_THSigmam_1")
    Tl2 = table("Trained Source Model_output/l(0)_THSigmam_2")
    Tl3 = table("Trained Source Model_output/l(0)_THSigmam_3")
    Tl4 = table("Trained Source Model_output/l(0)_THSigmam_4")
    Ta1 = table("Trained Source Model_output/a(0)_THSigmam_1")
    Ta2 = table("Trained Source Model_output/a(0)_THSigmam_2")
    Ta3 = table("Trained Source Model_output/a(0)_THSigmam_3")
    Ta4 = table("Trained Source Model_output/a(0)_THSigmam_4")
    Tc1 = table("Trained Source Model_output/c(0)_THSigmam_1")
    Tc2 = table("Trained Source Model_output/c(0)_THSigmam_2")
    Tc3 = table("Trained Source Model_output/c(0)_THSigmam_3")
    Tc4 = table("Trained Source Model_output/c(0)_THSigmam_4")
    Tm1 = table("Trained Source Model_output/int(m)_THSigmam_1")
    Tm2 = table("Trained Source Model_output/int(m)_THSigmam_2")
    Tm3 = table("Trained Source Model_output/int(m)_THSigmam_3")
    Tm4 = table("Trained Source Model_output/int(m)_THSigmam_4")
    Tf1 = table("Trained Source Model_output/int(f)_THSigmam_1")
    Tf2 = table("Trained Source Model_output/int(f)_THSigmam_2")
    Tf3 = table("Trained Source Model_output/int(f)_THSigmam_3")
    Tf4 = table("Trained Source Model_output/int(f)_THSigmam_4")
...
!history(x1, x2, x3, x4)=plot of x species in untrained macrophages at sigma m 1-4, as " ": plot titles, range(0, #): range y axis, PNG (1024, 2): save plot PNG 1024 pixels
    history(l1, l2, l3, l4) at (0) as "OxLDL at Endothelial Boundary" range(0, 80) PNG(1024, 2)
    history(Tl1, Tl2, Tl3, Tl4) at (0) as "OxLDL at Endothelial Boundary" range (0, 80) PNG(1024, 2)
	history(a1, a2, a3, a4) at (0) as "Chemoattractants at Endothelial Boundary "	range (0, 24000) PNG(1024, 2)
    history(Ta1, Ta2, Ta3, Ta4) at (0) as "Chemoattractants at Endotheilal Boundary" range (0, 24000) PNG(1024, 2)
    history(c1, c2, c3, c4) at (0) as "Cytokines at Endothelial Boundary" range (0, 1300) PNG(1024, 2)											
    history(Tc1, Tc2, Tc3, Tc4) at (0) as "Cytokines at Endotheial Boundary" range (0, 1300) PNG(1024, 2)
    history(integral(ldlc1), integral(ldlc2), integral(ldlc3), integral(ldlc4)) as "Rate of OxLDL Consumption" range (0, 210) PNG(1024, 2)
    history(integral(Tldlc1), integral(Tldlc2), integral(Tldlc3), integral(Tldlc4)) as "Rate of OxLDL Consumption" range (0, 210) PNG(1024, 2)
    history(mm1, mm2, mm3, mm4) at (0) as "Monocyte Migration" range(0, 3.2) PNG(1024, 2)
    history(Tmm1, Tmm2, Tmm3, Tmm4) at (0) as "Monocyte Migration" range(0, 3.2) PNG(1024, 2)
	history(m1, m2, m3, m4) as "Total Intimal Macrophages" range (0, 48) PNG(1024, 2)
    history(Tm1, Tm2, Tm3, Tm4) as "Total Intimal Macrophages" range (0,48) PNG(1024, 2)
	history(f1, f2, f3, f4) as "Total Intimal Foam Cells" range (0,6.2) PNG(1024, 2)
    history(Tf1, Tf2, Tf3, Tf4) at (0) as "Total Intimal Foam Cells" range (0,6.2) PNG(1024, 2)
